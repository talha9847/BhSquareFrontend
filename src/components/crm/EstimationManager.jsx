                      ...
                      <table className="w-full text-left border-collapse">
                        <thead className="bg-slate-50/50">
                          <tr>
                            ...
                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase w-32 text-center">
                              Qty
                            </th>
                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase w-40">
                              Unit Price
                            </th>
                            <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase w-40">
                              GST
