...
import { Sun, Mail, Lock, Eye, EyeOff, ArrowLeft, Loader2, Zap, BarChart2, Leaf } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0F2D6B] relative overflow-hidden flex-col items-center justify-center p-12">
          ...
          <div className="grid grid-cols-4 gap-3 mb-8">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                ...
                style={{ background: "linear-gradient(135deg, #1a5695 0%, #0F2D6B 50%, #1a5695 100%)" }}
              >
                <div className="w-full h-full rounded-xl grid grid-cols-2 gap-1 p-1 opacity-40">
                  {[0,1,2,3].map(j => <div key={j} className="bg-[#F5C518]/30 rounded-sm" />)}
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={l} className="text-center">
                  ...
                  <p className="font-display text-xl font-bold text-white">{v}<span className="text-xs text-blue-300">{u}</span></p>
        ...
        <div className="relative z-10 text-center mt-8">
          <h2 className="font-display text-3xl font-bold text-white mb-3">BHSquare CRM Portal</h2>
          <p className="text-blue-200 font-body">Manage installations, customers, and projects from one place.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#1a5695] font-body transition-colors mb-10">
            <ArrowLeft size={16} />
            Back to website
          </Link>
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <div>
              <p className="font-display font-bold text-xl text-[#0F2D6B]">BH<span className="text-[#1a5695]">Square</span></p>
              <p className="text-xs text-gray-400 -mt-0.5 font-body">CRM Portal</p>
            </div>
          </div>

          <h1 className="font-display text-3xl font-bold text-gray-900 mb-2">Welcome back</h1>
          <p className="text-gray-500 font-body mb-8">Sign in to access your dashboard.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 border rounded-xl font-body text-sm outline-none transition-all ${
                    errors.email ? "border-red-400 bg-red-50 focus:ring-2 focus:ring-red-100" : "border-gray-200 focus:border-[#1a5695] focus:ring-2 focus:ring-blue-100"
                  }`}
                />
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-sm font-semibold text-gray-700 font-body">Password</label>
                <a href="#" className="text-xs text-[#1a5695] hover:underline font-body">Forgot password?</a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3.5 border rounded-xl font-body text-sm outline-none transition-all ${
                    errors.password ? "border-red-400 bg-red-50 focus:ring-2 focus:ring-red-100" : "border-gray-200 focus:border-[#1a5695] focus:ring-2 focus:ring-blue-100"
                  }`}
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="remember" className="w-4 h-4 rounded border-gray-300 accent-[#1a5695]" />
              <label htmlFor="remember" className="text-sm text-gray-600 font-body">Remember me for 30 days</label>
            </div>
          ...
          <p className="text-center text-gray-400 text-xs font-body mt-8">
            ...
            <a href="mailto:admin@bhsquare.in" className="text-[#1a5695] hover:underline">admin@bhsquare.in</a>
          </p>
        </div>
      </div>
    </div>
