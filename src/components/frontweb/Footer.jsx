...
const socials = [
  {
    name: "Facebook",
    Icon: Facebook,
    href: "https://www.facebook.com/bhsquare.solar",
  },
  {
    name: "Instagram",
    Icon: Instagram,
    href: "https://www.instagram.com/bhsquare_solar/",
  },
  {
    name: "LinkedIn",
    Icon: Linkedin,
    href: "https://www.linkedin.com/company/bhsquare-solar-installation-and-services/?viewAsMember=true",
  },
  { name: "Twitter", Icon: Twitter, href: "#" },
  {
    name: "YouTube",
    Icon: Youtube,
    href: "https://www.youtube.com/@BHsquareSolar",
  },
];
...
const contactDetails = [
  ...
  { Icon: Mail, text: "harshwork2422@gmail.com" },
    ...
    <footer className="bg-[#0a1f4e] text-white">
      ...
      <div className="bg-gradient-to-r from-[#F5C518] to-[#F0A500]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-display font-bold text-[#1a5695] text-xl">
            Ready to power your life with solar? ☀️
          </p>
          <button
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((s) => (
                <li
                  key={s}
                  className="text-blue-200 text-sm font-body flex items-center gap-2"
                >
            ...
            <div className="space-y-4">
              {contactDetails.map(({ Icon, text }) => (
                <div key={text} className="flex gap-3">
                  <Icon
                    size={16}
                    className="text-[#F5C518] flex-shrink-0 mt-0.5"
                  />
                  <p className="text-blue-200 text-sm font-body whitespace-pre-line leading-relaxed">
                    {text}
                  </p>
                </div>
              ))}
      ...
      <div className="border-t border-blue-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-blue-400 font-body">
          <p>
            © {new Date().getFullYear()} BHSquare Solar Energy. All rights
            reserved.
          </p>
