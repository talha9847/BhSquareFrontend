...
const SCommission = () => {
  ...
  const getCommissions = async () => {
    try {
      setPageLoading(true);
      const res = await axios.get(`/api/sources/getPaidCommissionBySourceId`, {
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="text-[9px] font-black text-slate-400 uppercase tracking-tighter bg-slate-100 w-fit px-1.5 rounded">
                              {item.type}
                            </span>
                          </div>
                        </td>
